...
class CSlangParser ( Parser ):
    ...
    ruleNames =  [ "program", "prog_decl_list", "prog_decl", "exp", "exp1", 
                   ...
                   "func_type", "ref_type", "ele_type", "array_type", "decl", 
                   "class_decl", "class_mem_list", "class_mem", "obj_cre", 
                   "mem_access", "method_access", "inst_mem_access", "inst_method_access", 
    ...
    def ele_type(self):
        ...
        self.enterRule(localctx, 38, self.RULE_ele_type)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 255
