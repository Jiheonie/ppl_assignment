...
class CSlangParser ( Parser ):
    ...
    class Attr_decl_exp_shortContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitAttr_decl_exp_short" ):
                return visitor.visitAttr_decl_exp_short(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Attr_decl_exp_fullContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitAttr_decl_exp_full" ):
                return visitor.visitAttr_decl_exp_full(self)
            else:
                return visitor.visitChildren(self)
